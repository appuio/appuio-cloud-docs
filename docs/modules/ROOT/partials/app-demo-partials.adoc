// tag::introduction[]
image:logos/ghost-blog.png[role="related thumb right",alt="Demo application logo",width=120,height=120] This tutorial explains how to run {app-link} on {product}.
