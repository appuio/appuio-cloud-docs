...
This means the manifests from APPUiO Public can be exported, but needs to be updated, before applicable on APPUiO Cloud.
Often just the API of the object has to be changed.
For some new API versions, a different structure and other default values apply.
