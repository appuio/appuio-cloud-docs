...
. Change the runtime icon to match the C programming language or the GNU libmicrohttpd library framework (if available).
...
* When you're done testing the fortune application, you can open the "Projects" menu in the "Administrator" perspective to delete the `fortune-c` project.