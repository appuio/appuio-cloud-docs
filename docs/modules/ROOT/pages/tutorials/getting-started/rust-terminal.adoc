...
If you are not familiar with issuing commands on a terminal session, you might want to try the xref:tutorials/getting-started/rust-web.adoc[Getting Started with Rust on the OpenShift Web Console] guide instead.
