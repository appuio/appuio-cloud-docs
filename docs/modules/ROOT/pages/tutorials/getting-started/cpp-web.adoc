...
. Change the runtime icon to match the C++ programming language or the Drogon Framework framework (if available).
...
* When you're done testing the fortune application, you can open the "Projects" menu in the "Administrator" perspective to delete the `fortune-cpp` project.