...
If you are not familiar with issuing commands on a terminal session, you might want to try the xref:csharp-web.adoc[Getting Started with C# on the OpenShift Web Console] guide instead.
...
--
include::https://gitlab.com/vshn/applications/fortune-csharp/-/raw/master/Controllers/FortuneController.cs[tag=router]
--
...
--
include::https://gitlab.com/vshn/applications/fortune-csharp/-/raw/master/Dockerfile[tag=production]
--
