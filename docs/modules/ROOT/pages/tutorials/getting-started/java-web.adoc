...
. Change the runtime icon to match the Java programming language or the Quarkus Framework (if available).
. Click "Create."
...
** http://fortune-java-fortune-java.apps.[YOUR_PREFERRED_ZONE].appuio.cloud
