...
See xref:appcat:ROOT:exoscale-dbaas/postgresql/create.adoc[the AppCat docs for PostgreSQL] and xref:appcat:ROOT:appcat/object-storage/create.adoc[the AppCat docs for ObjectBucket] for more information.
