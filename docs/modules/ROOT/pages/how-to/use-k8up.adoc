...
Using the `restic` command line tool, we will now restore the backup locally on your system. Create a script named `environment.sh` that exports the required environment variables used by https://restic.net/[restic]:
