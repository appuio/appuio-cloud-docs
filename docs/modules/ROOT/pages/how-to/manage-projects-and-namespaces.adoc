...
If your user doesn't have a default organization, you must specify the label when creating the namespace or project. If you don't know your default organization name, try this:
