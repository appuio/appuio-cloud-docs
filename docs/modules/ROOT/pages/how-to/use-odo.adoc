...
At the time of this writing (version 2.5.0), odo cannot be used in a project with an https://github.com/redhat-developer/odo/issues/5110[existing `Dockerfile`] or an https://github.com/redhat-developer/odo/issues/5408[existing codebase]. These features may or may not be available in future versions.
