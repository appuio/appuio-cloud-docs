...
In the xref:how-to/manage-projects-and-namespaces.adoc[Managing Projects and Namespaces] page it is explained how to create projects and namespaces.
...
IMPORTANT: OpenShift groups do not have any notion of hierarchy! From the point of view of OpenShift, they all belong to the same flat structure.
