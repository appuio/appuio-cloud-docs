...
[CAUTION]
====
Templates and Image Streams are OpenShift-specific features, not available in other Kubernetes-based platforms. In all cases, it is recommended to read the https://docs.openshift.com/container-platform/4.9/welcome/index.html[official Red Hat OpenShift 4.9 documentation] for more detailed information.
====
